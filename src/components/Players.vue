<template>
    <div class="wrapper-player">
        <div class="player-panel" v-bind:class="getWinnerClass(0)">
            

                <div class="player-name">{{ getWinner(0) }}</div>
            ...
            <div class="player-panel" v-bind:class="getWinnerClass(1)">
                <div class="player-name">{{ getWinner(1) }}</div>
...
export default {
    ...
    methods: {
        getWinner(index) {
            ...
            // ng hiện tại và có ng thắng cuộc
        ...
        getWinnerClass(index) {
            return {
                active: this.activePlayer == index && !this.isWinner,
                winner: this.activePlayer == index && this.isWinner
            }
        }
